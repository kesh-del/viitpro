...
const cdmcMembers = [
  ...
  {
    sno: 3,
    name: 'Dr. V. S. V. Satyanarayana',
    designation: 'Associate Professor',
    status: 'Member – Faculty',
  },
  {
    sno: 4,
    name: 'Dr. B. Dhanunjaya Rao',
    designation: 'Associate Professor',
    status: 'Member – Faculty',
  },
  {
      ...
      <div className="flex max-w-screen-xl mx-auto">
        ...
        <main className="flex-1 p-6 overflow-x-auto">
          ...
          <section className="mb-8">
            <h3 className="text-xl font-semibold text-blue-800 mb-3">Members</h3>
          ...
          <section className="mb-8">
            ...
            <p className="mb-2 text-gray-700">
              The Curriculum Design & Monitoring Committee (CDMC) takes up the following activities:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700">
              <strong>Meeting:</strong> Twice in a year, or as and when necessary.
            </p>
          </section>
        </main>
      </div>
