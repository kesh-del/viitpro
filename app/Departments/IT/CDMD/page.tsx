    ...
    <div>
      ...
      <div className="flex max-w-screen-xl mx-auto">
        ...
        <main className="flex-1 p-6 overflow-x-auto">
          ...
          {/* Term and Meeting */}
          <section>
            <h3 className="text-xl font-semibold text-blue-800 mb-2">Term and Meetings</h3>
            <p className="text-gray-700 mb-1">
              <strong>Term:</strong> Shall continue to be in force until reconstitution
            </p>
            <p className="text-gray-700">
              <strong>Meeting:</strong> Twice in a year; meetings may be scheduled as and when necessary
            </p>
          </section>
        </main>
      </div>
